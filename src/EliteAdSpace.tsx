...
export default function EliteAdSpace() {
  ...
  return <section className="elite-ad-space" aria-label={t('Elite daily advertising space')}>
    <div className="elite-ad-copy">
      ...
      <div>
        <span className="eyebrow">{t('ELITE DAILY SPOT')}</span>
    ...
    <div className="elite-email-panel">
      ...
      <a className="elite-email-button" href={`mailto:${contactEmail}?subject=Elite%20daily%20spot%20inquiry`} aria-label={`${t('Email us about the featured spot')} — ${contactEmail}`}>
