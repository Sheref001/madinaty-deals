...
export interface CollectionFilters { category: string; advertiserType: string; condition: string; furnishing: string; min: string; max: string; educationLevel: string; subject: string; groceryActivity: string; homeServiceType: string; housekeepingType: string; fitnessProviderType: string; petBusinessType: string }
